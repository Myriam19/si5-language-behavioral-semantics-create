 ...
 */
package fr.unice.si5.polytech.validation;
...
public class CreateLanguageValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(CreateLanguageConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("CreateLanguage");
		if (section == null) {
			return dialogSettings.addNewSection("CreateLanguage");
		}
		return section;
	}
}
